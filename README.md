...
Scaffolding: CAPITAL/sUSD [`0x88f973BA…Cba9`](https://shannon-explorer.somnia.network/address/0x88f973BA7dae69474e609c8bc2CfCd159ae3Cba9), MockPriceOracle [`0xE31b784B…FE7d`](https://shannon-explorer.somnia.network/address/0xE31b784B34f7F986AA2965c33609e15533E0FE7d) (owned by the poller), SimGateway [`0x46CF6A9F…6457`](https://shannon-explorer.somnia.network/address/0x46CF6A9F7dA820f5dC12da68b734143f42fc6457) (makes the Simulate-depeg control permissionless for the demo stables, so anyone can test it), detection subscription `5981499`.

**Permissionless demo.** Every user action works from any wallet: buy coverage, provide liquidity, claim a payout, and even trigger a simulated depeg on a demo stable (through `SimGateway`, which allow-lists only the demo stables so the real-price live assets cannot be moved). Only configuration actions, registering a stable and switching a demo scenario, are operator-gated.
